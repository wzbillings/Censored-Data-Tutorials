...
> `r pnorm(15, mean = 13, sd = 2, lower.tail = FALSE)`
...
overall average is around 2.85, with a standard deviation of 1.05. Now, we want
...
a little messing around, and I found that $beta_0 = 2$ and $\beta_1 =$
